...
StPicoEvent::StPicoEvent(): TObject(),
  ...
  mNTofT0Can(0), mTStart(-9999*1000), mTCanFirst(99999*1000), mTCanLast(-99999*1000), mNVpdEGoodHits(0),
  mNVpdWGoodHits(0), mEarliestVpdEHit(99999*1000), mEarliestVpdWHit(99999*1000), mClosestVpdEHit(99999*1000),
